...
public interface GrupoControllerOpenApi {
    ...
    GrupoModel buscar(@ApiParam(value = "ID de um grupo", example = "1")
                      Long grupoId);
    ...
    GrupoModel adicionar(@ApiParam(name = "corpo", value = "Representacao de um novo grupo")
    ...
    GrupoModel atualizar(@ApiParam(value = "ID de um grupo", example = "1")
                         Long grupoId,
    ...
    void remover(@ApiParam(value = "ID de um grupo", example = "1")
                 Long grupoId);
}
